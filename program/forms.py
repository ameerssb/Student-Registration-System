...
from program.models import Session,Program_Type,Course,Faculty,Subject,Registration,Olevel,Upload
...
class ProgramForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for i in self.fields:
            ...
            self.fields[i].widget.attrs['class'] = 'form-select me-2'
...
class RequiremtForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(RequiremtForm,self).__init__(*args,**kwargs)
